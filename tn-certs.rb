...
CSV.foreach('./input.csv', headers: true) do |row|
  ...
  Prawn::Document.generate "output/#{teacher}/#{filename}.pdf", page_layout: :landscape do
    ...
    #stroke_axis
    move_down 20
    image "./resources/tn_logo_large.jpg", :position => :center, fit: [115,115]
    move_down 40
    ...
    text "2016 Tennessee Economics Challenge", size: 24, align: :center
    move_down 15
    font "./resources/OpenSans-Italic.ttf"
    ...
    image "./resources/dcampbell_signature.png", at: [0,125], fit: [200,50]
    stroke do
      stroke_color '666666'
      line_width 1
    ...
    text_box "Douglas Campbell\nDirector, Tennessee Center for Economic Education", at: [5,75]
#    text_box "Chris Caltabiano\nVice President, Domestic Programs\nCouncil for Economic Education", at: [5,75]
    text_box "March, 2016", at: [600,75]
  end
end
